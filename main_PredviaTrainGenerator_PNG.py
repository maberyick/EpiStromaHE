...
names = utils.all_files_under('/mnt/projects/CSE_BME_AXM788/data/CCF/Lung/700_TMA-10-06-2016/Lym_mask_German/LungCCFTMA/TMAs/','.png')
for name in names:
    print(name)
    savingName = '/scratch/users/crb138/TMA_Yale_79_140/epiStroma_tmaCCF_GAN/' + os.path.basename(name)[:-4] + '_mask'
