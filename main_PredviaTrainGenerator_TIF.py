...
names = utils.all_files_under('/mnt/pan/Data7/crb138/dataset/nuclei_ident/tma_image_qif/','.tif')
for name in names:
    print(name)
    savingName = '/scratch/users/crb138/epiStroma_tmaYale_qif_norm_GAN/' + os.path.basename(name)[:-4] + '_mask'
