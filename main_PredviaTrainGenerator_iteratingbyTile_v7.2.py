...
if utils.load_model(sess, saver, model_out_dir):
    ...
    print('=============================================')    
    print(' [*] Load Success!\n')
names = utils.all_files_under('/scratch/users/crb138/SCLC/mat_tiles/','.mat')
#names = utils.all_files_under('/scratch/users/crb138/subset_ETMA0Chemo/tiles/','.mat')
shuffle(names)
for name in names:
    print(name)
    savingName = '/scratch/users/crb138/SCLC/ESmask/' + os.path.basename(name)[:-4] + '_ESmask'
